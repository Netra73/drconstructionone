...
class DetailsPageStateAdmin extends State<DetailsPageAdmin>{
  ...
  DetailsPageStateAdmin(this.Eid);
  @override
  void initState() {
                              ...
                              children: [
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          if(status.toString()!="3") GestureDetector(
                                              onTap: (){
                                                _DeleteDialog(data['id'], context);
                                              },
                                              child: Image.asset('assets/images/dustbin.jpg',width: 30,height: 30,)),
                                        ],
                                      ),
                                      SizedBox(height: 5),
                                      Row(
                                ...
                                if(btnTrue) Container(
                                  ...
                                  child: RaisedButton(
                                    ...
                                    child: Text("Complete",style: mainStyle.text16White,),
                                  ),
                                ),
